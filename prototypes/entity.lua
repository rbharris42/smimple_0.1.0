data:extend(
    {
        ...
        },
        {
            ...
            icon_size = 32,
            flags = {"placeable-neutral", "placeable-player", "player-creation"},
            minable = {mining_time = 1, result = "hydrolic-press"},
            max_health = 300,
            corpse = "medium-remnants",
            vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
            working_sound = {
            ...
            selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
            animation = {
                filename = "__smimple__/graphics/entity/hydrolic-press.png",
                priority = "high",
                width = 32,
                height = 32,
                frame_count = 1,
            ...
            fast_replaceable_group = "hydrolic-press"
        },
        {
            type = "furnace",
            name = "smelter",
            ...
            icon_size = 32,
            flags = {"placeable-neutral", "placeable-player", "player-creation"},
            minable = {mining_time = 1, result = "smelter"},
            max_health = 300,
            corpse = "medium-remnants",
            vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
            working_sound = {
            ...
            selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
            animation = {
                filename = "__smimple__/graphics/entity/furnace.png",
                priority = "high",
                width = 32,
                height = 32,
                frame_count = 1,
        ...
        },
        {
            ...
            icon_size = 32,
            flags = {"placeable-neutral", "placeable-player", "player-creation"},
            minable = {hardness = 0.2, mining_time = 0.5, result = "crafter"},
            fast_replaceable_group = "crafter",
            max_health = 150,
            corpse = "big-remnants",
            collision_box = {{-0.4, -0.4}, {0.4, 0.4}},
            selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
            animation = {
                filename = "__smimple__/graphics/entity/crafter.png",
                priority = "high",
                width = 32,
                height = 32,
                frame_count = 1,
